...
export class Productservice {
  ...
  public sendSearchRequest(page: any, keyword: any): Observable<any>
  {
    ...
    return this.http.get<any>(`http://127.0.0.1:8000/api/products/search/${page}/${keyword}/`, options);
  }
  ...
  public sendProductRequest(page: any): Observable<any>
  {
    ...
    return this.http.get<any>(`http://127.0.0.1:8000/api/products/list/${page}/`, options);
